...
export const EnhancedShowcaseSection = () => {
  ...
  return <div className="py-12 sm:py-20 bg-gradient-to-b from-background via-muted/5 to-background construction-pattern overflow-safe">
            ...
            <CardContent className="p-8 space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  ...
                  Your investment is protected by our commitment to excellence and quality craftsmanship.
                </p>
              </div>
