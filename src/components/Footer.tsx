          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <a href="tel:+61414922276" className="font-medium text-white hover:text-secondary transition-colors">+61 414 922 276</a>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <a href="mailto:romanspropertyservices@gmail.com" className="font-medium text-white hover:text-secondary transition-colors">romanspropertyservices@gmail.com</a>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm text-white/60">
              ...
              <a href="/sitemap" className="hover:text-secondary transition-smooth">Sitemap</a>
            </div>
          </div>
        </div>
      </div>
