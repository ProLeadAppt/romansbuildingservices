  ...
  const workByService = {
    ...
    heritage: [
      ...
      },
      {
        ...
        features: ['Stone carving restoration', 'Structural stabilization', 'Stone protection', 'Heritage compliance'],
        duration: '12 weeks',
    ...
    remedial: [
      {
        ...
        description: 'Comprehensive building defect rectification including facade repairs and stonework restoration.',
        images: [beforeAfterImage, professionalTeam, heroBackground],
        features: ['Defect rectification', 'Facade restoration', 'Stone protection', 'Compliance upgrades'],
        duration: '8 weeks',
    ...
    concrete: [
      {
        ...
        description: 'Specialized concrete cancer treatment with stone stabilization for coastal exposure.',
