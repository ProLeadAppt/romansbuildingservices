...
export const ModernNavigation = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 px-4 lg:px-6">
      <motion.nav 
        ref={navRef}
        className="w-full max-w-7xl mx-auto mt-4 mb-2 bg-white/10 backdrop-blur-xl shadow-2xl border border-white/20 rounded-2xl transition-all duration-300 ease-out"
        initial={false}
        animate={{ y: 0 }}
