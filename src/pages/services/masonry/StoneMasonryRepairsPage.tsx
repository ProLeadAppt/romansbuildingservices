...
const StoneMasonryRepairsPage = () => {
  ...
  return (
    <ServicePageTemplate
      ...
      metaTitle="Sandstone & Stone Masonry Repairs Sydney | Romans Building Services"
      metaDescription="Sydney stone masonry repairs by Minas Romanakis. Sandstone, bluestone, limestone, granite. Hand-dressed replacement, lime repointing, dutchman repairs. 30 years on the tools."
