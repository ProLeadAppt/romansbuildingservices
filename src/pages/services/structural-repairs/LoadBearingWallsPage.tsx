...
const LoadBearingWallsPage = () => {
  ...
  return (
    <ServicePageTemplate
      ...
      metaTitle="Load-Bearing Wall Repairs Sydney | Crack Stitching, Rebuilds | Romans Building Services"
      metaDescription="Sydney load-bearing wall repairs by Minas Romanakis. Crack stitching, pier rebuilds, lintel replacement, helibar reinforcement. Engineer-certified, AS 3700 compliant."
